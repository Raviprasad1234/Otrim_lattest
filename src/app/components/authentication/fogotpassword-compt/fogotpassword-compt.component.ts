...
@Component({
  selector: 'app-fogotpassword-compt',
  templateUrl: './fogotpassword-compt.component.html',
  styleUrls: ['./fogotpassword-compt.component.css']
})
export class FogotpasswordComptComponent implements OnInit {
