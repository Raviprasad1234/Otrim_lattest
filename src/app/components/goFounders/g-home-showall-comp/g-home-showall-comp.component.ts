...
@Component({
  selector: 'app-g-home-showall-comp',
  templateUrl: './g-home-showall-comp.component.html',
  styleUrls: ['./g-home-showall-comp.component.css']
})
export class GHomeShowallCompComponent implements OnInit {
  ...
  goBack() {
    this.router.navigate(['gofounders', this.userid]).then(() => {
